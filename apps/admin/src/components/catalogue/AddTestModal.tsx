...
export function AddTestModal({ isOpen, onClose, onSuccess, centres }: AddTestModalProps) {
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2 border border-gray-200 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary-500"
              placeholder="Additional preparation instructions..."
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 pt-2">
            <div className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg bg-gray-50">
              <input
                ...
                className="w-5 h-5 bg-white border-gray-300 rounded text-primary-600 focus:ring-primary-500 focus:ring-2 cursor-pointer checked:bg-primary-600 checked:border-primary-600"
              />
              <label htmlFor="fasting_required" className="text-sm font-medium text-gray-700 cursor-pointer">
                Fasting Required
              </label>
            </div>
            ...
            <div className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg bg-gray-50">
              <input
                ...
                className="w-5 h-5 bg-white border-gray-300 rounded text-primary-600 focus:ring-primary-500 focus:ring-2 cursor-pointer checked:bg-primary-600 checked:border-primary-600"
              />
              <label htmlFor="home_collection" className="text-sm font-medium text-gray-700 cursor-pointer">
